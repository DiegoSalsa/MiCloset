...
-- Tabla de relación Prendas en Outfits (muchos a muchos)
...
CREATE TABLE outfit_recommendations (
    ...
    reasoning TEXT, -- Por qué se recomendó este outfit
    liked BOOLEAN DEFAULT NULL, -- null = sin valorar, true = gustó, false = no gustó
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE color_compatibility (
    ...
    compatibility_score DECIMAL(3, 2), -- 0 a 1, qué tan bien combinan
...
('Hoodies', 'Sudaderas y hoodies', 'femenino', '🧥'),
('Chaquetas', 'Abrigos y chaquetas', 'femenino', '🧥'),
...
('Hoodies', 'Sudaderas y hoodies', 'masculino', '🧥'),
('Chaquetas', 'Abrigos y chaquetas', 'masculino', '🧥'),
